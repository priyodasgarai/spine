...
@section('Main-content-header')
 <h1>DOCUMENTS</h1><small>-Terms of Use, Waiver, Function & Symptom Survey, Uploads, etc...</small>
@endsection
            ...
            <form role="form" method="post" action="{{url('document-upload')}}" enctype="multipart/form-data"> 
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" value="2" name="file_type"/>
                </div>                
                <div class="form-group">
                  <label>Select multiple document file for uploaded</label>
                  <input type="file" name="file_name" multiple="">

                  <p class="help-block">Upload medical documents Spine Solutions</p>
                </div>
